...
public class TransactionsTabFragment extends Fragment {
    ...
    public static TransactionsTabFragment newInstance(ArrayList<AppInboxModel> inboxMessages) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        ArrayList<AppInboxModel> filteredModels
                ...
                (inbox -> inbox.getTags().contains("Transactions")).collect(Collectors.toList());
